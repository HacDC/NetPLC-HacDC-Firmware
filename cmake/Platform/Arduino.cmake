...
function(setup_arduino_bootloader_upload TARGET_NAME BOARD_ID PORT AVRDUDE_FLAGS)
    ...
    #find_program(ARD_RESET_ARDUINO_PROGRAM
    #NAMES ard-reset-arduino
    ...
    add_custom_target(${UPLOAD_TARGET}
                     COMMAND ${ARDUINO_RESET_PROGRAM}
                     --caterina
                     ${PORT}
                     COMMAND ${ARDUINO_AVRDUDE_PROGRAM}
                     ${AVRDUDE_ARGS}
                     DEPENDS ${TARGET_NAME})
    else()
    add_custom_target(${UPLOAD_TARGET}
...
#                          Initialization                                     
#=============================================================================#
find_program(ARDUINO_RESET_PROGRAM
        NAMES ard-reset-arduino
        PATHS ${CMAKE_SOURCE_DIR}/cmake
        )
